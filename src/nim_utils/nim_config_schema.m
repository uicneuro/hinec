...
% --- integrator -------------------------------------------------------------
e('tractography.integrator.method',     'rk4',         'string',  {'euler','rk2','rk4','rkf45'}, [], {'integrator'}, {'hinec','mmf'}, 'Numerical stepping scheme. NOTE: this is a method NAME, not an order claim. rkf45 here is Dormand-Prince: it advances on the 5th-order solution and uses the embedded 4th-order one only to size the next step.')
